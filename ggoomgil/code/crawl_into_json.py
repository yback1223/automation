...
class GgoomgilCrawler:
            ...
            while True:
                ...
                for program_row in program_rows:
                    try:
                        ...
                        # 개별 항목에서 문제가 생겨도 프로그램이 종료되지 않도록 처리
        ...
        try:
            ...
            for row in rows:
                try:
                    ...
                    print(f"[경고] 학교 레벨({school_level}) 상세 정보를 읽는 중 오류가 발생했습니다: {e}")
                    continue

            return info

        except Exception as e:
            print(f"[경고] 학교 레벨({school_level}) 섹션을 찾는 중 오류가 발생했습니다: {e}")
            return {}
    ...
    def extract_place(self):
        try:
            ...
            print(f"[경고] 체험 장소 추출 중 오류가 발생했습니다: {e}")
            return ""
    ...
    def extract_program_term(self):
        try:
            ...
            print(f"[경고] 체험 기간(프로그램 신청 기간) 추출 중 오류가 발생했습니다: {e}")
            return ""
        ...
        try:
            ...
            for dl in dl_elements:
                try:
                    ...
                    print(f"[경고] DL 요소( {dl.text} ) 정보 추출 중 오류: {e}")
                    continue

            return data
        except Exception as e:
            print(f"[경고] dl_wrap 요소를 찾는 중 오류가 발생했습니다: {e}")
            return {}
    ...
    def extract_notice(self):
        ...
        try:
            ...
            print(f"[경고] 유의사항 추출 중 오류가 발생했습니다: {e}")
            return ""
    ...
    def extract_location_info(self):
        ...
        try:
            ...
            print(f"[경고] 찾아가는 방법 추출 중 오류가 발생했습니다: {e}")
            return ""
    ...
    def extract_available_regions(self):
        ...
        try:
            ...
            print(f"[경고] 체험 가능 지역 정보 추출 중 오류가 발생했습니다: {e}")
            return []
    ...
    def click_close_button(self):
        ...
        try:
            ...
            print(f"[경고] 닫기 버튼 클릭 중 오류가 발생했습니다: {e}")
